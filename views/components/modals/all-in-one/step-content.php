...
<div class="wp-sms-modal__aio-step js-wp-sms-aioModalStep wp-sms-modal__aio-step--<?php echo esc_attr($step_name) ?>">
    ...
    <?php if ($step_name !== 'first-step') : ?>
        ...
        <?php endif; ?>
    <?php else: ?>
        <img class="wp-sms-aio-step__image v-image-lazy" alt="WP SMS AIO Step" width="509" height="291" data-src="<?php echo WP_SMS_URL . 'assets/images/premium-modal/first-step.png'; ?>">
    <?php endif; ?>
</div>