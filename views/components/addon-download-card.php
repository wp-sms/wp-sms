...
<div class="wps-addon__download__item <?php echo !$included ? 'wps-addon__download__item--disabled' : ''; ?>">
        ...
        <div class="wps-addon__download__item--info__text">
            <div class="wps-addon__download__item--info__title">
                ...
                <?php if (!empty($addOn->getProductUrl())) : ?>
                    <a target="_blank" href="<?php echo esc_html($addOn->getProductUrl()); ?>?utm_source=wp-sms&utm_medium=link&utm_campaign=dp" class="wps-postbox-addon__read-more" title="<?php esc_html_e('Learn More', 'wp-sms'); ?>">
                        <?php esc_html_e('Learn More', 'wp-sms'); ?>
                    </a>
                <?php endif; ?>

                <?php if ($included && $addOn->isUpdateAvailable()) : ?>
                    <span class="wps-postbox-addon__label wps-postbox-addon__label--updated"><?php esc_html_e('Update Available', 'wp-sms'); ?></span>
                <?php endif; ?>
            </div>
    ...
    <div class="wps-addon__download__item--select">
        <?php if ($included && $addOn->isInstalled()) : ?>
            <span class="wps-postbox-addon__status wps-postbox-addon__status--installed "><?php esc_html_e('Already installed', 'wp-sms'); ?></span>
        <?php elseif (!$included) : ?>
            <span class="wps-postbox-addon__status wps-postbox-addon__status--primary "><?php esc_html_e('Not included', 'wp-sms'); ?></span>
        <?php endif; ?>
