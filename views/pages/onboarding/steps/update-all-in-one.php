<div class="c-section__title">
    <span class="c-section__step">Step 5 of 7</span>
    <h1 class=" u-m-0">Purchase WP SMS Pro</h1>
    <p class="u-m-0">
            ...
            <div class="c-proplan">
                <div class="c-proplan__header u-flex u-content-center u-align-center u-flex--column">
                    <div>
                        ...
                        <h3 class="c-proplan__title">Pro Plan</h3>
                    </div>

                    <p class="c-proplan__price u-text-center">
                        From <strong>$29</strong> per Year </p>
                    <div>
                        <a class="c-btn c-btn--ghost c-btn--proplan" title="Buy now" href="https://wp-sms-pro.com/buy/?utm_source=wp-sms&utm_medium=link&utm_campaign=onboarding" target="_blank">
                            Buy now
                        </a>
                        <p class="c-proplan__desc">14-day money-back guarantee on all the plans.</p>
                    </div>
                </div>
                <div class="c-proplan__features u-flex u-content-sp u-align-stretch">
                    ...
                    <div class="c-feature-card u-flex u-content-start u-align-start">
                        ...
                        <div class="c-feature-card__content">
                            <h2 class="c-feature-card__title">2FA & SMS Login</h2>
                            <p class="c-feature-card__desc u-m-0">
                                Enhance the security of your WordPress site with Two Factor Authentication SMS. </p>
                        </div>
                    </div>
                    <div class="c-feature-card u-flex u-content-start u-align-start">
                        ...
                        <div class="c-feature-card__content">
                            <h2 class="c-feature-card__title">Scheduled SMS</h2>
                            <p class="c-feature-card__desc u-m-0">
                                Integrates with popular plugins like WooCommerce,
                                Contact Form, and more. </p>
                        </div>
