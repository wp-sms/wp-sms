<div class="c-section__title">
    ...
    <h1 class=" u-m-0"><?php esc_html_e('Test Your Setup', 'wp-sms'); ?></h1>
    <p class="u-m-0">
    ...
    <div class="c-section__test">
        <div class="wpsms-admin-alert wpsms-admin-alert--success">
            <div class="wpsms-admin-alert--content">
                <p>
                    <?php esc_html_e('A test message will be sent to the phone number you provided earlier. Please
                check your device for the message.', 'wp-sms'); ?>
                </p>
            </div>
        </div>
        <div class="wpsms-admin-alert wpsms-admin-alert--info">
            <div class="wpsms-admin-alert--content">
                <h2><?php esc_html_e('Did you receive the test SMS?', 'wp-sms'); ?></h2>
                <p>
                    <?php esc_html_e('If you\'ve received the test SMS, clicking \'Yes, I received it!\' will
            confirm your setup is correct and take you to the next step. If not, select \'No, I didn\'t receive it.\' for
            troubleshooting options.', 'wp-sms'); ?>
                </p>
            </div>
        </div>
    </div>
