...
<div class="c-ready-row">
    <h3 class="c-ready__title">Our products</h3>
    <div class="c-ready__items u-flex u-align-stretch u-content-sp">
        <div class="c-readycard">
            <svg fill="none" height="28" width="28" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="c-readycard">
            ...
            <h2 class="c-readycard__title">WP SlimStat</h2>
            <p class="c-readycard__desc">
                Find everything you need to get WP-SMS up and running. </p>
            <a class="c-btn" href="https://wp-slimstat.com/?utm_source=wp-sms&utm_medium=link&utm_campaign=onboarding" target="_blank" title="Learn more">Learn more</a>
        </div>
        <div class="c-readycard">
            ...
            <h2 class="c-readycard__title">FeedbackBird</h2>
            <p class="c-readycard__desc">
                Find everything you need to get WP-SMS up and running.</p>
            <a class="c-btn" href="https://feedbackbird.io/?utm_source=wp-sms&utm_medium=link&utm_campaign=onboarding" title="Learn more" target="_blank">Learn more</a>
        </div>
    </div>
</div>