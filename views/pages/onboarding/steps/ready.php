<form method="post">
    ...
    <div class="c-ready-row">
        ...
        <div class="c-ready__items u-flex u-align-stretch u-content-sp">
            ...
            <div class="c-readycard c-readycard--integration">
                <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M15.4497 21.2241L16.7991 18.9586H13.1268L14.4763 21.2241L12.587 27.4319L14.9671 30L17.3389 27.4319L15.4496 21.2241H15.4497ZM22.0664 18.6887H21.4121L14.9672 29.7628L8.52227 18.6887H7.86797C5.89685 18.6887 4.28564 20.2999 4.28564 22.271V30H25.6488V22.271C25.6488 20.2999 24.0376 18.6887 22.0665 18.6887H22.0664ZM17.9687 8.99674C17.1263 8.99674 16.4393 9.68379 16.4393 10.5262H19.5063C19.5063 9.68383 18.8193 8.99674 17.9687 8.99674H17.9687ZM11.9573 8.99674C11.1148 8.99674 10.4278 9.68379 10.4278 10.5262H13.4948C13.4866 9.68383 12.7996 8.99674 11.9571 8.99674H11.9573ZM20.1771 5.32443H18.803L18.1569 3.70501H15.4661V2.62538C15.9732 2.42911 16.3249 1.93834 16.3249 1.36584C16.3249 0.613339 15.7115 0 14.959 0C14.2066 0 13.5932 0.61342 13.5932 1.36584C13.5932 1.93834 13.9531 2.42907 14.452 2.62538V3.70501H11.7612L11.115 5.32443H9.74919C7.14012 5.32443 5.14447 7.60637 5.62703 10.1582L7.05014 17.4455H22.8681L24.2912 10.1582C24.7819 7.60637 22.7945 5.32443 20.1772 5.32443H20.1771ZM22.3689 9.97821C22.3689 15.4908 7.56517 15.4908 7.56517 9.97821C7.56517 8.66957 8.57117 7.5818 9.87159 7.4673H20.0543C21.3629 7.58176 22.3689 8.66961 22.3689 9.97821Z" fill="#D75676"/>
                </svg>
                <h2 class="c-readycard__title">
                ...
                <div class="u-flex u-align-center"><a title="<?php esc_attr_e('All-in-One Required', 'wp-sms'); ?>" target="_blank" href="https://wp-sms-pro.com/buy/?utm_source=wp-sms&utm_medium=link&utm_campaign=onboarding" class="c-readycard__badge"><?php _e('All-in-One Required', 'wp-sms'); ?></a></div>
            </div>
            <div class="c-readycard c-readycard--integration">
                <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
