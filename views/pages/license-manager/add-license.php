<div class="wpsms-wrap__main">
    ...
    <div class="wpsms-postbox-addon__step">
        ...
        <a class="wpsms-addon__step__back-to-addons" href="<?php echo esc_url(admin_url('admin.php?page=wps_plugins_page')) ?>" title="<?php esc_html_e('Back to Add-Ons', 'wp-sms'); ?>"><?php esc_html_e('Back to Add-Ons', 'wp-sms'); ?></a>
