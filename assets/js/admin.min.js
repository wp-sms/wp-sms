...
eval("function _typeof(o) { \"@babel/helpers - typeof\"; return _typeof = \"function\" == typeof Symbol && \"symbol\" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && \"function\" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? \"symbol\" : typeof o; }, _typeof(o); }\nfunction _createForOfIteratorHelper(o, allowArrayLike) { var it = typeof Symbol !== \"undefined\" && o[Symbol.iterator] || o[\"@@iterator\"]; if (!it) { if (Array.isArray(o) || (it = _unsupportedIterableToArray(o)) || allowArrayLike && o && typeof o.length === \"number\") { if (it) o = it; var i = 0; var F = function F() {}; return { s: F, n: function n() { if (i >= o.length) return { done: true }; return { done: false, value: o[i++] }; }, e: function e(_e) { throw _e; }, f: F }; } throw new TypeError(\"Invalid attempt to iterate non-iterable instance.\\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.\"); } var normalCompletion = true, didErr = false, err; return { s: function s() { it = it.call(o); }, n: function n() { var step = it.next(); normalCompletion = step.done; return step; }, e: function e(_e2) { didErr = true; err = _e2; }, f: function f() { try { if (!normalCompletion && it[\"return\"] != null) it[\"return\"](); } finally { if (didErr) throw err; } } }; }\nfunction _unsupportedIterableToArray(o, minLen) { if (!o) return; if (typeof o === \"string\") return _arrayLikeToArray(o, minLen); var n = Object.prototype.toString.call(o).slice(8, -1); if (n === \"Object\" && o.constructor) n = o.constructor.name; if (n === \"Map\" || n === \"Set\") return Array.from(o); if (n === \"Arguments\" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return _arrayLikeToArray(o, minLen); }\nfunction _arrayLikeToArray(arr, len) { if (len == null || len > arr.length) len = arr.length; for (var i = 0, arr2 = new Array(len); i < len; i++) arr2[i] = arr[i]; return arr2; }\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\nfunction _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, _toPropertyKey(descriptor.key), descriptor); } }\nfunction _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); Object.defineProperty(Constructor, \"prototype\", { writable: false }); return Constructor; }\nfunction _toPropertyKey(t) { var i = _toPrimitive(t, \"string\"); return \"symbol\" == _typeof(i) ? i : i + \"\"; }\nfunction _toPrimitive(t, r) { if (\"object\" != _typeof(t) || !t) return t; var e = t[Symbol.toPrimitive]; if (void 0 !== e) { var i = e.call(t, r || \"default\"); if (\"object\" != _typeof(i)) return i; throw new TypeError(\"@@toPrimitive must return a primitive value.\"); } return (\"string\" === r ? String : Number)(t); }\ndocument.addEventListener('DOMContentLoaded', function () {\n  var modal = document.querySelector('.js-wp-sms-premiumModal');\n  var welcomeContent = document.querySelector('.js-wp-sms-premiumModalWelcomeContent');\n  var premiumStepsContent = document.querySelector('.js-wp-sms-premiumModalSteps');\n  var premiumSteps = document.querySelectorAll('.js-wp-sms-premiumModalStep');\n  var premiumWelcomeSteps = document.querySelectorAll('.js-wp-sms-premiumModal-welcome .js-wp-sms-premiumModalStep');\n  var exploreButton = document.querySelector('.js-wp-sms-premiumModalExploreBtn');\n  var premiumFeatures = document.querySelectorAll('.js-wp-sms-premiumStepFeature');\n  var upgradeButtonBox = document.querySelectorAll('.wp-sms-premium-step__action-container');\n  var premiumBtn = document.querySelectorAll('.js-wp-sms-openPremiumModal');\n  var autoSlideInterval;\n  var currentStepIndex = 1;\n  if (premiumBtn.length > 0) {\n    premiumBtn.forEach(function (button) {\n      button.addEventListener('click', function (event) {\n        event.preventDefault();\n        var href = button.getAttribute('href');\n        var target = button.getAttribute('data-target');\n        openModal(target, href);\n      });\n    });\n  }\n  var skipButtons = document.querySelectorAll('.js-wp-sms-premiumModalClose');\n  if (skipButtons.length > 0) {\n    skipButtons.forEach(function (button) {\n      button.addEventListener('click', closeModal);\n    });\n  }\n  var closeModal = function closeModal() {\n    if (modal) {\n      modal.style.display = 'none';\n      document.body.style.overflow = '';\n    }\n  };\n  var setMaxHeightForAllSteps = function setMaxHeightForAllSteps() {\n    if (premiumSteps.length === 0) {\n      return;\n    }\n    var maxStepHeight = 0;\n    premiumSteps.forEach(function (step) {\n      var originalDisplay = step.style.display;\n      step.style.display = 'block';\n      step.style.minHeight = 'auto';\n      var stepHeight = step.getBoundingClientRect().height;\n      maxStepHeight = Math.max(maxStepHeight, stepHeight);\n      step.style.display = originalDisplay;\n    });\n    premiumSteps.forEach(function (step) {\n      step.style.minHeight = \"\".concat(maxStepHeight, \"px\");\n    });\n  };\n\n  // Optionally, re-run the function when the window is resized\n  window.addEventListener('resize', setMaxHeightForAllSteps);\n  var openModal = function openModal(target, href) {\n    if (modal) {\n      modal.style.display = 'block';\n      document.body.style.overflow = 'hidden';\n    }\n    var targetIndex = Array.from(premiumFeatures).findIndex(function (step) {\n      return step.getAttribute('data-modal') === target;\n    });\n    if (targetIndex !== -1) {\n      currentStepIndex = targetIndex;\n      if (welcomeContent) {\n        welcomeContent.style.display = 'none';\n      }\n      loadModalImages();\n      showStep(currentStepIndex + 1);\n      premiumStepsContent.style.display = 'block';\n      stopAutoSlide();\n    }\n  };\n\n  // Hide the premium steps initially\n  premiumSteps.forEach(function (step) {\n    step.classList.remove('wp-sms-modal__premium-step--active');\n  });\n  if (exploreButton) {\n    exploreButton.addEventListener('click', function () {\n      currentStepIndex = 0;\n      loadModalImages();\n      welcomeContent.style.display = 'none';\n      premiumStepsContent.style.display = 'block';\n      showStep(currentStepIndex);\n      startAutoSlide();\n    });\n  }\n  var loadModalImages = function loadModalImages() {\n    document.querySelectorAll('.wp-sms-premium-step__image').forEach(function (img) {\n      img.src = img.dataset.src;\n    });\n  };\n\n  // Function to show a specific step and sync the sidebar\n  var showStep = function showStep(index) {\n    setTimeout(function () {\n      setMaxHeightForAllSteps();\n    }, 100);\n    if (index < 0 || index >= premiumSteps.length) return;\n    premiumSteps.forEach(function (step) {\n      return step.classList.remove('wp-sms-modal__premium-step--active');\n    });\n    if (upgradeButtonBox && upgradeButtonBox.length > 0) {\n      upgradeButtonBox.forEach(function (btn) {\n        if (btn) {\n          btn.classList.remove('active');\n        }\n      });\n      if (upgradeButtonBox[index - 1]) {\n        upgradeButtonBox[index - 1].classList.add('active');\n      }\n    }\n    premiumFeatures.forEach(function (feature) {\n      return feature.classList.remove('active');\n    });\n    premiumSteps[index].classList.add('wp-sms-modal__premium-step--active');\n    if (index > 0) {\n      premiumFeatures[index - 1].classList.add('active');\n    }\n  };\n\n  // Function to start the auto-slide process\n  var startAutoSlide = function startAutoSlide() {\n    autoSlideInterval = setInterval(function () {\n      currentStepIndex = (currentStepIndex + 1) % premiumWelcomeSteps.length; // Loop through steps\n      showStep(currentStepIndex); // Show the current step and sync sidebar\n    }, 5000); // Adjust time interval to 5 seconds\n  };\n  var stopAutoSlide = function stopAutoSlide() {\n    clearInterval(autoSlideInterval);\n  };\n\n  // Event listeners for each premium step feature\n  if (premiumFeatures.length > 0) {\n    premiumFeatures.forEach(function (feature, index) {\n      feature.addEventListener('click', function () {\n        stopAutoSlide(); // Stop auto-slide when user interacts\n        currentStepIndex = index + 1;\n        showStep(currentStepIndex);\n      });\n    });\n  }\n  var ModalHandler = /*#__PURE__*/function () {\n    function ModalHandler() {\n      _classCallCheck(this, ModalHandler);\n      this.init();\n    }\n    return _createClass(ModalHandler, [{\n      key: \"init\",\n      value: function init() {\n        var _this = this;\n        document.addEventListener('click', function (event) {\n          var button = event.target.closest('[class*=\"js-openModal-\"]');\n          if (button) {\n            var modalId = _this.extractModalIdFromClass(button.classList);\n            if (modalId) {\n              _this.openModal(modalId);\n            }\n          }\n          var actionButton = event.target.closest('button[data-action]');\n          if (actionButton) {\n            var action = actionButton.getAttribute('data-action');\n            if (action) {\n              var _modal = actionButton.closest('.wp-sms-modal');\n              _this.handleModalAction(_modal, action);\n            }\n          }\n        });\n        this.attachOpenEvent();\n        this.attachCloseEvent();\n      }\n\n      // Event delegation for opening modals\n    }, {\n      key: \"attachOpenEvent\",\n      value: function attachOpenEvent() {\n        var _this2 = this;\n        document.addEventListener('click', function (event) {\n          // Check if the clicked element or its parent matches the selector\n          var button = event.target.closest('[class*=\"js-openModal-\"]');\n          if (button) {\n            var modalId = _this2.extractModalIdFromClass(button.classList);\n            if (modalId) {\n              _this2.openModal(modalId);\n            }\n          }\n        });\n      }\n    }, {\n      key: \"extractModalIdFromClass\",\n      value: function extractModalIdFromClass(classList) {\n        var _iterator = _createForOfIteratorHelper(classList),\n          _step;\n        try {\n          for (_iterator.s(); !(_step = _iterator.n()).done;) {\n            var className = _step.value;\n            if (className.startsWith('js-openModal-')) {\n              return className.replace('js-openModal-', '').toLowerCase();\n            }\n          }\n        } catch (err) {\n          _iterator.e(err);\n        } finally {\n          _iterator.f();\n        }\n        return null;\n      }\n    }, {\n      key: \"openModal\",\n      value: function openModal(modalId) {\n        var modal = document.getElementById(modalId);\n        if (modal) {\n          modal.classList.add('wp-sms-modal--open');\n        } else {\n          console.error(\"Modal with ID \\\"\".concat(modalId, \"\\\" not found.\"));\n        }\n      }\n\n      // Event delegation for closing modals\n    }, {\n      key: \"attachCloseEvent\",\n      value: function attachCloseEvent() {\n        document.addEventListener('click', function (event) {\n          var button = event.target.closest('.wp-sms-modal__close');\n          if (button) {\n            var _modal2 = button.closest('.wp-sms-modal');\n            if (_modal2) {\n              _modal2.classList.remove('wp-sms-modal--open');\n            }\n          }\n        });\n      }\n    }, {\n      key: \"handleModalAction\",\n      value: function handleModalAction(modal, action) {\n        switch (action) {\n          case 'resolve':\n            break;\n          case 'closeModal':\n            this.closeModal(modal);\n            break;\n          default:\n            console.warn('Unknown action:', action);\n        }\n      }\n    }, {\n      key: \"closeModal\",\n      value: function closeModal(modal) {\n        modal.classList.remove('wp-sms-modal--open');\n      }\n    }]);\n  }();\n  new ModalHandler();\n});\n\n//# sourceURL=webpack://wp-sms/./assets/src/scripts/modal-handler.js?");
...
/******/ 	__webpack_require__("./assets/src/scripts/quick-reply.js");
/******/ 	__webpack_require__("./assets/src/scripts/import-subscriber.js");
/******/ 	__webpack_require__("./assets/src/scripts/admin.js");
/******/ 	__webpack_require__("./assets/src/scripts/admin-export.js");
/******/ 	__webpack_require__("./assets/src/scripts/admin-send-sms.js");
/******/ 	__webpack_require__("./assets/src/scripts/edit-subscriber.js");
/******/ 	__webpack_require__("./assets/src/scripts/edit-group.js");
/******/ 	__webpack_require__("./assets/src/scripts/admin-privacy-data.js");
/******/ 	__webpack_require__("./assets/src/scripts/admin-order-view.js");
/******/ 	__webpack_require__("./assets/src/scripts/admin-dashboard-stats-widget.js");
/******/ 	__webpack_require__("./assets/src/scripts/chart.min.js");
/******/ 	var __webpack_exports__ = __webpack_require__("./assets/src/scripts/modal-handler.js");
/******/ 	
/******/ })()
;