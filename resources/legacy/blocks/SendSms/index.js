        ...
        return (
            <div {...blockProps}>
                <div className="wp-sms-block wp-sms-block--sendSms">
                    {title && <h2 className="wp-sms-block__title">{title}</h2>}
                    {description && <p className="wp-sms-block__description">{description}</p>}
                    <div className="wp-sms-block__form">
                        {/* The actual form will be rendered by PHP */}
                        <div className="wp-sms-block__placeholder">
                            [wp_sms_send_sms_form]
                        </div>
                    </div>
                </div>
            </div>
