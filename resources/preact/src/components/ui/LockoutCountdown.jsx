...
export function LockoutCountdown({ seconds: initialSeconds, onExpire }) {
    ...
    return (
        <div className="wsms-auth-lockout">
            ...
            <div className="wsms-auth-lockout__title">Account temporarily locked</div>
            <p className="wsms-auth-text-sm wsms-auth-text-muted">Too many failed attempts</p>
            ...
            <p className="wsms-auth-text-xs wsms-auth-text-muted">You can try again when the timer expires</p>
        </div>
    );
}
