...
export function AlertCircleIcon({ size = 16, class: cls }) {
    return (
        <svg {...svgBase} width={size} height={size} class={cls}>
            <circle cx="12" cy="12" r="10"/>
...
export function WsmsLogo({ size = 24, class: cls }) {
    return (
        <svg viewBox="0 0 512 512" fill="currentColor" width={size} height={size} class={cls}>
