import { h as Subscribable, n as notifyManager, s as shallowEqualObjects, i as replaceEqualDeep, k as useQueryClient, r as reactExports, l as noop, _ as __, j as jsxRuntimeExports, e as cn, R as Route, m as getSchemaByGroup, o as getSettingsValuesByGroup } from "./main-D1KP0B5-.js";
import { Q as QueryObserver, u as useIsRestoring, a as useQueryErrorResetBoundary, e as ensureSuspenseTimers, b as ensurePreventErrorBoundaryRetry, c as useClearResetErrorBoundary, s as shouldSuspend, f as fetchOptimistic, w as willFetch, g as getHasError, d as defaultThrowOnError, h as useSaveSettingsValues, S as SchemaForm } from "./use-save-settings-values-BPUIfNdJ.js";
...
const Chatbox = ({ settings }) => {
  ...
  const toggleChatboxVisibility = reactExports.useCallback(() => {
    setIsVisible((prev) => {
  ...
  reactExports.useEffect(() => {
    window.toggleWpSmsChatbox = toggleChatboxVisibility;
    return () => {
      delete window.toggleWpSmsChatbox;
    };
  ...
  const animationClasses = {
    ...
    slide: isAnimating ? isOpen ? "animate-in slide-in-from-bottom-[12%] duration-500" : "animate-out slide-out-to-bottom-[12%] duration-500" : ""
  };
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "span",
                {
                  ...
                  children: /* @__PURE__ */ jsxRuntimeExports.jsx("svg", { xmlns: "http://www.w3.org/2000/svg", width: "12", height: "8", fill: "none", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "path",
                    {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-5 h-5 mr-1.5", children: /* @__PURE__ */ jsxRuntimeExports.jsx("svg", { xmlns: "http://www.w3.org/2000/svg", width: "20", height: "20", fill: "none", viewBox: "0 0 20 20", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                "path",
                {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-base font-bold", children: chatbox_button_text })
            ]
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            className: cn(
              ...
              chatbox_animation_effect && animationClasses[chatbox_animation_effect]
            ),
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  ...
                  style: { backgroundColor: chatbox_color, color: chatbox_text_color },
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "m-0 p-0 text-base font-bold", style: { color: chatbox_text_color }, children: chatbox_title }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "button",
                      {
                        className: "bg-transparent p-0 cursor-pointer border-none hover:opacity-80 transition-opacity",
                        onClick: toggleChatbox,
                        children: /* @__PURE__ */ jsxRuntimeExports.jsx("svg", { width: "12", height: "12", viewBox: "0 0 12 12", fill: "none", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                          "path",
                          {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-h-[54vh] md:max-h-[65vh] overflow-y-auto overflow-x-hidden scrollbar-thin scrollbar-thumb-gray-400 scrollbar-track-gray-300", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 flex flex-col gap-4", children: [
                chatbox_team_members && chatbox_team_members.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 rounded-lg overflow-hidden", children: chatbox_team_members.map((member, index) => {
                  ...
                  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "a",
                    {
                      ...
                      children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx(
                            "span",
                            {
                              ...
                              children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: getContactIcon(member.member_contact_type), alt: "", className: "w-[13px]" })
                            }
                          ),
                          /* @__PURE__ */ jsxRuntimeExports.jsx(
                            "img",
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "p-0 m-0 list-none flex flex-col gap-1", children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { className: "text-sm leading-[16.41px] break-words font-normal", children: member.member_role }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { className: "text-base leading-[18.75px] capitalize font-bold", children: member.member_name }),
                          /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-center gap-1 text-xs leading-[14.06px]", children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-block w-3 h-3 rounded-full border-2 border-teal-100 bg-teal-500" }),
                            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: member.member_availability })
                          ] })
                        ] }) })
                      ]
                    },
                ...
                chatbox_links_enabled && chatbox_links && chatbox_links.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 rounded-lg overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "p-0 m-0 flex flex-col gap-1 list-none", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("li", { className: "p-3 text-gray-700 dark:text-gray-300 text-sm font-bold", children: chatbox_links_title }),
                  chatbox_links.map((link, index) => {
                    if (!link.link_title) return null;
                    return /* @__PURE__ */ jsxRuntimeExports.jsx("li", { className: "border-t border-gray-200 dark:border-gray-800", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      "a",
                      {
                        href: link.link_url,
                        ...
                        children: [
                          link.link_title,
                          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("svg", { width: "6", height: "10", viewBox: "0 0 6 10", fill: "none", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                            "path",
                            {
                              d: "M5 9L1 5L5 1",
                              stroke: "#4F7EF6",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border-t border-gray-200 dark:border-gray-800 text-gray-700 dark:text-gray-300 leading-[15px]", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 pb-2.5 text-xs", style: { color: chatbox_footer_text_color }, children: [
                  chatbox_footer_text,
                  chatbox_footer_link_url && chatbox_footer_link_title && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                    " ",
                    /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: chatbox_footer_link_url, className: "text-blue-500 hover:text-blue-600", children: chatbox_footer_link_title })
                  ] })
                ] }),
                !chatbox_disable_logo && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pt-0 px-4 pb-4 flex uppercase font-semibold text-[9px] leading-[10.5px] tracking-[-0.3px] gap-1 text-gray-600 dark:text-gray-400", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "a",
                    {
                      ...
                      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { width: "56", height: "9", viewBox: "0 0 56 9", fill: "none", className: "inline", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx(
                          "path",
                          {
                            fillRule: "evenodd",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "span",
                {
                  ...
                  children: /* @__PURE__ */ jsxRuntimeExports.jsx("i", { className: "inline-block absolute -top-2.5 -left-[9px] w-0 h-0 border-l-[9px] border-l-transparent border-b-[9px] border-b-transparent border-t-[9px] border-t-gray-50 dark:border-t-gray-950 border-r-[9px] border-r-transparent" })
                }
              )
            ]
          }
...
function RouteComponent() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(SchemaForm, { formSchema: schema, defaultValues, onSubmit: handleSubmit }),
    showChatbox && /* @__PURE__ */ jsxRuntimeExports.jsx(Chatbox, { settings: defaultValues })
  ] });
}
export {
