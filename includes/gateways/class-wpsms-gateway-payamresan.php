...
class payamresan extends \WP_SMS\Gateway
{
    ...
    public function SendSMS()
    {
        ...
        $client = $this->request('GET', "{$this->wsdl_link}APISend.aspx?Username={$this->username}&Password={$this->password}&From={$this->from}&To={$to}&Text={$message}");
    ...
    public function GetCredit()
    {
        ...
        $client = $this->request('GET', "{$this->wsdl_link}Credit.aspx?Username={$this->username}&Password={$this->password}");
