...
class onewaysms extends \WP_SMS\Gateway {
	private $wsdl_link = "http://onewaysms.com/";
	...
	public function __construct() {
		...
		$this->help           = "Use API field as your web service panel API URL like : 'http://gateway.onewaysms.com.my:10001/' or what ever the the gateway URL is.";
	}
	...
	public function SendSMS() {
		...
		$response = wp_remote_get( $this->wsdl_link . "api.aspx?apiusername=" . $this->username . "&apipassword=" . $this->password . "&message=" . $text . "&mobileno=" . $to . "&senderid=" . $this->from . "&languagetype=" . $type );
	...
	public function GetCredit() {
		...
		$response = wp_remote_get( $this->wsdl_link . "bulkcredit.aspx?apiusername={$this->username}&apipassword={$this->password}" );
