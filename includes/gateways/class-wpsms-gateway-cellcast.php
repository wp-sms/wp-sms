...
class cellcastsms extends Gateway
{
    ...
    public function __construct()
    {
        ...
        $this->help            = "To receive a token, please consult the guide on <a href='https://developer.cellcast.com/getting-started/api-key.html' target='_blank'>generating REST API keys</a> for detailed instructions. For <b>bulk send</b>, set Delivery Method to Batch SMS Queue.";
        $this->gatewayFields   = [
            'gateway_token' => [
                'id'   => 'gateway_token',
                'name' => 'Token',
    ...
    public function GetCredit()
    {
        try {
            ...
            return 'Cellcast does not provide credit balance. Please check your cellcast account for billing information.';
        } catch (Exception $e) {
