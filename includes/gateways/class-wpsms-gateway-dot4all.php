...
class dot4all extends \WP_SMS\Gateway
{
    ...
    public function SendSMS()
    {
        ...
        $result = $this->request('GET', "{$this->wsdl_link}batch.php?user={$this->username}&pass={$this->password}&rcpt={$to}&data={$msg}&sender={$this->from}&qty=n");
    ...
    public function GetCredit()
    {
        ...
        $result = $this->request('GET', "{$this->wsdl_link}credit.php?user={$this->username}&pass={$this->password}");
