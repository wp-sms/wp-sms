<h2 class="nav-tab-wrapper">
	...
	<a href="?page=wp-sms-settings&tab=web-service" class="nav-tab<?php if(isset($_GET['tab']) and $_GET['tab'] == 'web-service') { echo " nav-tab-active"; } ?>"><?php _e('SMS Gateway', 'wp-sms'); ?></a>
	<a href="?page=wp-sms-settings&tab=newsletter" class="nav-tab<?php if(isset($_GET['tab']) and $_GET['tab'] == 'newsletter') { echo " nav-tab-active"; } ?>"><?php _e('Newsletter', 'wp-sms'); ?></a>
	<a href="?page=wp-sms-settings&tab=features" class="nav-tab<?php if(isset($_GET['tab']) and $_GET['tab'] == 'features') { echo " nav-tab-active"; } ?>"><?php _e('Features', 'wp-sms'); ?></a>
