...
if (apply_filters('wp_sms_enable_upgrade_to_bundle', true)) :
    ...
    <div class="license-status license-status--free">
        <a class="upgrade" href="<?php echo esc_url(WP_SMS_SITE . '/pricing?utm_source=wp-sms&utm_medium=link&utm_campaign=plugins'); ?>" target="_blank">
            <span><?php esc_html_e('UPGRADE TO ALL-IN-ONE', 'wp-sms'); ?></span>
        </a>
    </div>
<?php else : ?>
    <div class="license-status license-status--valid">
        <a class="upgrade" href="<?php echo esc_url(WP_SMS_SITE . '/product-category/add-ons?utm_source=wp-sms&utm_medium=link&utm_campaign=plugins'); ?>">
                <span>
