...
<div class="wrap wpsms-wrap">
    ...
    <div class="wpsms-wrap__top">
        ...
        <div class="wpsms-button-group">
            <a title="<?php esc_html_e('Add Subscriber', 'wp-sms'); ?>" href="admin.php?page=wp-sms-subscribers#TB_inline?&width=400&height=250&inlineId=add-subscriber" class="thickbox button"><span class="dashicons dashicons-admin-users"></span> <?php esc_html_e('Add Subscriber', 'wp-sms'); ?></a>
            <a itle="<?php esc_html_e('Manage Groups', 'wp-sms'); ?>" href="<?php echo esc_url(WP_SMS_ADMIN_URL . 'admin.php?page=wp-sms-subscribers-group') ?>" class="button"><span class="dashicons dashicons-category"></span> <?php esc_html_e('Manage Groups', 'wp-sms'); ?></a>
            <a title="<?php esc_html_e('Import', 'wp-sms'); ?>" href="admin.php?pagecomposer install --ignore-platform-req=php =wp-sms-subscribers#TB_inline?&width=500&height=270&inlineId=wp-sms-import-from" class="thickbox button"><span class="dashicons dashicons-undo"></span> <?php esc_html_e('Import', 'wp-sms'); ?></a>
