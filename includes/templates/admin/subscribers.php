...
<div class="wrap wpsms-wrap">
    ...
    <div class="wpsms-wrap__top">
        ...
        <div class="wpsms-button-group">
            <a title="<span class='wps-tick-title wps-tick-title__subscriber'><?php esc_html_e('Add Subscriber', 'wp-sms'); ?></span>" name="<?php esc_html_e('Add Subscriber', 'wp-sms'); ?>" href="admin.php?page=wp-sms-subscribers#TB_inline?&width=400&height=250&inlineId=add-subscriber" class="thickbox button"><span class="dashicons dashicons-admin-users"></span> <?php esc_html_e('Add Subscriber', 'wp-sms'); ?></a>
            ...
            <a title="<span class='wps-tick-title wps-tick-title__import'><?php esc_html_e('Import', 'wp-sms'); ?></span>" name="<?php esc_html_e('Import', 'wp-sms'); ?>" href="admin.php?page=wp-sms-subscribers#TB_inline?&width=500&height=270&inlineId=wp-sms-import-from" class="thickbox button"><span class="dashicons dashicons-undo"></span> <?php esc_html_e('Import', 'wp-sms'); ?></a>
            <a title="<span class='wps-tick-title wps-tick-title__export'><?php esc_html_e('Export', 'wp-sms'); ?></span>" name="<?php esc_html_e('Export', 'wp-sms'); ?>" href="admin.php?page=wp-sms-subscribers#TB_inline?&width=400&height=150&inlineId=wp-sms-export-from" class="thickbox button"><span class="dashicons dashicons-redo"></span> <?php esc_html_e('Export', 'wp-sms'); ?></a>
        </div>
    </div>
