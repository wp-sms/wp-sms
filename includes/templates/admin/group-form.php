    ...
    <table>
        <tr>
            <td>
                ...
                <input type="text" dir="auto" id="wp_group_name" name="wp_group_name" placeholder="<?php esc_html_e('Name', 'wp-sms'); ?>" value="<?php echo isset($group_name) ? esc_attr($group_name) : ''; ?>" class="wp_sms_subscribers_input_text" required/>
