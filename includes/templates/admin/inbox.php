    ...
    <div class="wpsms-wrap__main wpsms-inbox-page">
        ...
        <div class="promotion-modal">
            ...
            <h3 class="promotion-modal__screenshot">
                <img src="<?php echo WP_SMS_URL . '/assets/images/wp-sms-two-way-chagemode.jpg'; ?>" alt="">
            </h3>
            ...
            <div class="promotion-modal__features">
                ...
                <div class="promotion-modal__feature__col">
                    <div class="promotion-modal__features__item"><span class="dashicons dashicons-saved"></span> <?php _e('Show In Chat Mode', 'wp-sms'); ?></div>
