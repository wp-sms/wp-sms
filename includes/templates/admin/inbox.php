<div class="wrap wpsms-wrap">
    <div class="wpsms-wrap__main wpsms-inbox-page">
        ...
        <div class="promotion-modal">
            ...
            <p class="promotion-modal__desc"><?php _e('This feature is available through the WP-SMS Two-Way add-on which allows you to receive messages and do actions with them such as unsubscribe, cancel order, etc.'); ?></p>
