<div class="wrap wpsms-wrap">
    ...
    <div class="wpsms-wrap__main wpsms-inbox-page">
        <img class="background-img" src="<?php echo esc_url(WP_SMS_URL . '/public/react/images/blurred-inbox.jpg'); ?>" alt="">
        <div class="promotion-modal">
            ...
            <div class="promotion-modal__screenshot">
                <img src="<?php echo esc_url(WP_SMS_URL . '/public/react/images/wp-sms-two-way-chagemode.png'); ?>" alt="">
            </div>
