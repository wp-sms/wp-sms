    ...
    <div class="wpsms-wrap__main wpsms-inbox-page">
        ...
        <div class="promotion-modal">
            ...
            <div class="promotion-modal__actions">
                <a target="_blank" href="<?php echo esc_url(WP_SMS_SITE . '/product/wp-sms-two-way/?utm_source=wp-sms&utm_medium=link&utm_campaign=inbox'); ?>" class="button-primary"><?php esc_html_e('Discover More About WP SMS Two Way!', 'wp-sms'); ?></a>
            </div>
        </div>
    </div>
</div>
