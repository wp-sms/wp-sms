    ...
    <div data-repeater-list="wpsms_settings[<?php echo esc_attr($args['id']) ?>]">
            ...
            <?php foreach ($value as $key => $data) : ?>
                ...
                <div class="repeater-item" data-repeater-item>
                    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px 40px; border-bottom: 1px solid #ccc; margin-bottom: 15px;">
                        <div>
                            <input aria-label="<?php esc_attr_e('Name', 'wp-sms'); ?>" type="text" placeholder="<?php esc_html_e('Emily Brown', 'wp-sms') ?>" name="member_name" value="<?php echo esc_attr($member_name) ?>" style="display: block; width: 99%;" />
                            <p class="description"><?php esc_html_e('Team member\'s name, e.g., \'Jane Doe\'', 'wp-sms') ?></p>
                        </div>
                        <div>
                            <input aria-label="<?php esc_attr_e('Role', 'wp-sms'); ?>" type="text" placeholder="<?php esc_html_e('Marketing Manager', 'wp-sms') ?>" name="member_role" value="<?php echo esc_attr($member_role) ?>" style="display: block; width: 99%;" />
                        ...
                        <div>
                            <div style="display: flex; gap: 5px; justify-content: space-between; width: 100%;">
                                <input aria-label="<?php esc_attr_e('Photo', 'wp-sms'); ?>" id="member_photo_field[<?php echo esc_attr($key) ?>]" type="text" class="wpsms_settings_upload_field" placeholder="<?php esc_html_e('Photo', 'wp-sms') ?>" value="<?php echo esc_attr($member_photo) ?>" name="member_photo" style="width: 80%"/>
                        ...
                        <div>
                            <input aria-label="<?php esc_attr_e('Availability', 'wp-sms'); ?>" type="text" placeholder="<?php esc_html_e('Available 10AM-5PM PST', 'wp-sms') ?>" value="<?php echo esc_attr($member_availability) ?>" name="member_availability" style="width: 100%;" />
                        ...
                        <div>
                            <input aria-label="<?php esc_attr_e('Contact Value', 'wp-sms'); ?>" type="text" placeholder="<?php esc_html_e('+1122334455', 'wp-sms') ?>" name="member_contact_value" value="<?php echo esc_attr($member_contact_value) ?>" style="display: block; width: 99%;"/>
        ...
        <?php else : ?>
            <div class="repeater-item" data-repeater-item>
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px 40px; border-bottom: 1px solid #ccc; margin-bottom: 15px;">
                    <div>
                        <input aria-label="<?php esc_attr_e('Name', 'wp-sms'); ?>" type="text" placeholder="<?php esc_html_e('Emily Brown', 'wp-sms') ?>" name="member_name" style="display: block; width: 100%;" />
                        <p class="description"><?php esc_html_e('Team member\'s name, e.g., \'Jane Doe\'', 'wp-sms') ?></p>
                    </div>
                    <div>
                        <input aria-label="<?php esc_attr_e('Role', 'wp-sms'); ?>" type="text" placeholder="<?php esc_html_e('Marketing Manager', 'wp-sms') ?>" name="member_role" style="display: block; width: 100%;" />
                        <p class="description"><?php esc_html_e('Team member\'s department or role, e.g., \'Customer Support\'', 'wp-sms') ?></p>
                    </div>
                    <div>
                        <div style="display: flex; gap: 5px; justify-content: space-between; width: 100%;">
                            <input aria-label="<?php esc_attr_e('Photo', 'wp-sms'); ?>" id="member_photo_field" type="text" class="wpsms_settings_upload_field" placeholder="<?php esc_html_e('Photo', 'wp-sms') ?>" name="member_photo" style="width: 80%"/>
                    ...
                    <div>
                        <input aria-label="<?php esc_attr_e('Availability', 'wp-sms'); ?>" type="text" placeholder="<?php esc_html_e('Available 10AM-5PM PST', 'wp-sms') ?>" name="member_availability" style="width: 100%;" />
                        <p class="description"><?php esc_html_e('State team member\'s chat hours, e.g., \'Available 10AM-5PM PST.\'', 'wp-sms') ?></p>
                    </div>
                    <div>
                        <select aria-label="<?php esc_attr_e('Contact Type', 'wp-sms'); ?>" name="member_contact_type" style="display: block; min-width: 100%;">
                    ...
                    <div>
                        <input aria-label="<?php esc_attr_e('Contact Value', 'wp-sms'); ?>" type="text" placeholder="<?php esc_html_e('+1122334455', 'wp-sms') ?>" name="member_contact_value" style="display: block; width: 100%;"/>
                        <p class="description"><?php esc_html_e('Provide contact details for the chosen method.', 'wp-sms') ?></p>
                    </div>
                    <div>
                        <input type="button" value="<?php esc_html_e('Delete', 'wp-sms') ?>" class="button" style="margin-bottom: 15px;" data-repeater-delete/>
