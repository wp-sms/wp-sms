<div class="repeater">
                ...
                <div style="display: block; width: 100%; margin-bottom: 15px; border-bottom: 1px solid #ccc;">
                    <div style="display: block; width: 48%; float: left; margin-bottom: 15px;">
                        <select name="order_status" style="display: block; width: 100%;">
                            <option value=""><?php _e('Please Choose', 'wp-sms'); ?></option>
                        ...
                        <p class="description"><?php _e('Please choose an order status', 'wp-sms'); ?></p>
                    </div>
                    <div style="display: block; width: 48%; float: right; margin-bottom: 15px;">
                        <select name="notify_status" style="display: block; width: 100%;">
                            <option value=""><?php _e('Please Choose', 'wp-sms'); ?></option>
                            <option value="1" <?php echo ($notify_status == '1') ? 'selected' : '' ?>><?php _e('Enable', 'wp-sms'); ?></option>
                            <option value="2" <?php echo ($notify_status == '2') ? 'selected' : '' ?>><?php _e('Disable', 'wp-sms'); ?></option>
                        </select>
                        <p class="description"><?php _e('Please select notify status', 'wp-sms'); ?></p>
                    </div>
            ...
            <div class="repeater-item" data-repeater-item>
                <div style="display: block; width: 100%; margin-bottom: 15px; border-bottom: 1px solid #ccc;">
                    ...
                    <div style="display: block; width: 48%; float: right; margin-bottom: 15px;">
                        <select name="notify_status" style="display: block; width: 100%;">
                            <option value=""><?php _e('Please Choose', 'wp-sms'); ?></option>
                            <option value="1"><?php _e('Enable', 'wp-sms'); ?></option>
                            <option value="2"><?php _e('Disable', 'wp-sms'); ?></option>
                        </select>
                        <p class="description"><?php _e('Please select notify status', 'wp-sms'); ?></p>
                    </div>
                    <div style="display: block; width: 100%; margin-bottom: 15px;">
    ...
    <div style="margin: 10px 0;">
        <input type="button" value="<?php _e('Add another order status', 'wp-sms'); ?>" class="button button-primary" data-repeater-create/>
    </div>
</div>