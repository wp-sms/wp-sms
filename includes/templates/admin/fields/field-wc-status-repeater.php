            ...
            <div class="repeater-item" data-repeater-item>
                <div style="display: block; width: 100%; margin-bottom: 15px; border-bottom: 1px solid #ccc;">
                    <div class="wp-sms-notify-specific-order">
                        <div>
                            <select name="order_status" style="display: block; width: 100%;" aria-label="<?php esc_attr_e('Choose an order status', 'wp-sms'); ?>">
                        ...
                        <div>
                            <select name="notify_status" style="display: block; width: 100%;" aria-label="<?php esc_attr_e('Select notify status', 'wp-sms'); ?>">
                                <option value=""><?php esc_html_e('Please Choose', 'wp-sms'); ?></option>
