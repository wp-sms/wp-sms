            ...
            <div class="repeater-item" data-repeater-item>
                <div style="display: block; width: 100%; margin-bottom: 15px; border-bottom: 1px solid #ccc;">
                    <div class="wp-sms-notify-specific-order">
                        <div>
                            <select name="order_status" style="display: block; width: 100%;" aria-label="Choose an order status">
                        ...
                        <div>
                            <select name="notify_status" style="display: block; width: 100%;" aria-label="Select notify status">
                                <option value=""><?php esc_html_e('Please Choose', 'wp-sms'); ?></option>
                    ...
                    <div style="display: block; width: 100%; margin-bottom: 15px;">
                        <textarea aria-label="Enter the contents of the SMS message" name="message" rows="3" style="display: block; width: 100%;"><?php echo esc_html($message) ?></textarea>
        ...
        <?php endforeach; ?><?php else : ?>
            <div class="repeater-item" data-repeater-item>
                <div style="display: block; width: 100%; margin-bottom: 15px; border-bottom: 1px solid #ccc;">
                    ...
                    <div style="display: block; width: 100%; margin-bottom: 15px;">
                        <textarea aria-label="Enter the contents of the SMS message" name="message" rows="3" style="display: block; width: 100%;"></textarea>
                        <p class="description"><?php esc_html_e('Enter the contents of the SMS message.', 'wp-sms'); ?></p>
                        <p class="description"><?php echo wp_kses_post($args['options']['variables']); ?></p>
                    </div>
                    <div>
