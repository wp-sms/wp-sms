    ...
    <div data-repeater-list="wpsms_settings[<?php echo esc_attr($args['id']) ?>]">
                ...
                <div class="repeater-item" data-repeater-item>
                    <div style="display: block; width: 100%; margin-bottom: 15px; border-bottom: 1px solid #ccc; overflow: hidden;">
                        <div style="display: block; width: 48%; float: left; margin-bottom: 15px;">
                            <input placeholder="<?php _e('Troubleshooting Common Issues', 'wp-sms') ?>" type="text" name="chatbox_link_title" style="display: block; width: 99%;" value="<?php echo esc_attr($chatbox_link_title) ?>" />
                        ...
                        <div style="display: block; width: 48%; float: right; margin-bottom: 15px;">
                            <input placeholder="<?php echo site_url('troubleshooting'); ?>" type="text" name="chatbox_link_url" style="display: block; width: 99%;" value="<?php echo esc_url($chatbox_link_url) ?>" />
                        </div>
                        <div>
        ...
        <?php else : ?>
            <div class="repeater-item" data-repeater-item>
                <div style="display: block; width: 100%; margin-bottom: 15px; border-bottom: 1px solid #ccc; overflow: hidden;">
                    <div style="display: block; width: 48%; float: left; margin-bottom: 15px;">
                        <input placeholder="<?php _e('Troubleshooting Common Issues', 'wp-sms') ?>" type="text" name="chatbox_link_title" style="display: block; width: 99%;" />
                        <p class="description"><?php _e('Add titles and URLs for your resource links, e.g., \'FAQs\' or \'Contact Us\'', 'wp-sms') ?></p>
                    </div>
                    <div style="display: block; width: 48%; float: right; margin-bottom: 15px;">
                        <input placeholder="<?php echo site_url('troubleshooting'); ?>" type="text" name="chatbox_link_url" style="display: block; width: 99%;" />
                    </div>
                    <div>
                        <input type="button" value="<?php _e('Delete', 'wp-sms') ?>" class="button" style="margin-bottom: 15px;" data-repeater-delete/>
                    </div>
