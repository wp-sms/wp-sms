...
<div class="graphical-reports">
    ...
    <table>
        <tr>
            <td>
                <img src="<?php echo esc_url(WP_SMS_URL . 'public/images/icons/success-sms.png'); ?>" class="icon"/>
                <span class="value"><?php echo esc_html($sms_data['success']); ?></span>
                <span class="name"><?php esc_html_e('Successful SMS', 'wp-sms'); ?></span>
            </td>
            <td>
                <img src="<?php echo esc_url(WP_SMS_URL . 'public/images/icons/failed-sms.png'); ?>" class="icon"/>
        ...
        <tr>
            <td>
                <img src="<?php echo esc_url(WP_SMS_URL . 'public/images/icons/active-user.png'); ?>" class="icon"/>
            ...
            <td>
                <img src="<?php echo esc_url(WP_SMS_URL . 'public/images/icons/added-user.png'); ?>" class="icon"/>
