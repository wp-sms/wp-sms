<head>
    ...
    <style type="text/css">
        <?php echo file_get_contents(WP_SMS_DIR . 'public/legacy/css/mail.min.css'); // phpcs:ignore WordPress.WP.AlternativeFunctions.file_get_contents_file_get_contents
        ?>
    </style>
</head>
...
<body style="margin:0; padding:0;">
    <div class="mail-body">
        ...
        <div class="main-section">
            ...
            <table class="header" style="background-image: url(<?php echo esc_url(WP_SMS_URL . 'public/react/images/email-background.jpg'); ?>);">
                <tr>
                    <td></td>
                    <td style="vertical-align: bottom; width:35%;">
                        <a href="<?php echo esc_url(WP_SMS_SITE); ?>" target="_blank" class="wp-sms-logo">
                            <img src="<?php echo esc_url(WP_SMS_URL . '/public/react/images/email-logo.png'); ?>">
                        </a>
                    </td>
                </tr>
            </table>
