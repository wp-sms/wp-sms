    ...
    <div class="mail-body">
        ...
        <div class="main-section">
            ...
            <div class="content">
                ...
                <a href="<?php echo esc_url($cta_link); ?>" class="button"><?php echo esc_html($cta_title); ?></a>

                <p><?php _e('Thank you!', 'wp-sms'); ?></p>
            </div>
        </div>
