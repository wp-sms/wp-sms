...
<div class="wpsms-chatbox wpsms-chatbox--ltr  wpsms-chatbox--orange-theme" style="<?php echo $chatbox->getButtonPosition() === 'bottom_right' ? 'left: unset; right: 1rem' : '' ?>">
