...
<div class="wpsms-header-banner" style="<?php echo isset($full_width_banner) && $full_width_banner ? 'margin-left: -20px; width: auto; max-width: none;' : ''; ?>">
    ...
    <div class="wpsms-header-items-flex">
        <a class="documentation" target="_blank" href="<?php echo esc_url(WP_SMS_SITE . '/documentation/'); ?>"><span class="icon"></span><?php esc_html_e('Documentation', 'wp-sms'); ?></a>
        <a class="gateway" target="_blank" href="<?php echo esc_url(WP_SMS_SITE . '/gateways/'); ?>"><span class="icon"></span><?php esc_html_e('Gateways Directory', 'wp-sms'); ?></a>
        ...
        <a class="licenses<?php echo ' ' . esc_attr($active); ?>" href="<?php echo esc_url($tab_url); ?>"><span class="icon"></span><?php esc_html_e('Manage Licenses', 'wp-sms'); ?></a>
    </div>
    ...
    <?php else : ?>
        <div class="license-status license-status--valid">
            <span><?php echo sprintf(esc_html__('License Status: %s of %s Activated.', 'wp-sms'), count(array_filter($addons)), count($addons)); ?></span>
        </div>
    <?php endif; ?>
