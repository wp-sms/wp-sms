<div id="wpcf7-wpsms" class="contact-form-editor-wpsms">
	...
	<fieldset>
		...
		<table class="form-table">
			...
			<table class="form-table">
				<tr>
					<th scope="row"><label for="wpcf7-sms-sender-form"><?php _e('Send to field', 'wp-sms'); ?>:</label></th>
					<td>
				...
				<tr>
					<th scope="row"><label for="wpcf7-sms-message-form"><?php _e('Message body', 'wp-sms'); ?>:</label></th>
					<td>
