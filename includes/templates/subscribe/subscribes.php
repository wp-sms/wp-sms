<div class="wrap">
    ...
    <div class="wpsms-button-group">
        <a name="<?php _e( 'Add Subscribe', 'wp-sms' ); ?>"
           href="admin.php?page=wp-sms-subscribers#TB_inline?&width=400&height=250&inlineId=add-subscriber"
        ...
        <a name="<?php _e( 'Import', 'wp-sms' ); ?>"
           href="admin.php?page=wp-sms-subscribers#TB_inline?&width=400&height=270&inlineId=import-subscriber"
           class="thickbox button"><span
                    class="dashicons dashicons-undo"></span> <?php _e( 'Import', 'wp-sms' ); ?></a>
        <a name="<?php _e( 'Export', 'wp-sms' ); ?>"
           href="admin.php?page=wp-sms-subscribers#TB_inline?&width=400&height=150&inlineId=export-subscriber"
           class="thickbox button"><span
        ...
        <form action="" method="post">
            <table>
                ...
                <tr>
                    <td style="padding-top: 10px;">
                        <label for="wp_subscribe_mobile"
                               class="wp_sms_subscribers_label"><?php _e( 'Mobile', 'wp-sms' ); ?></label>
                        <input type="text" id="wp_subscribe_mobile" name="wp_subscribe_mobile"
                               class="wp_sms_subscribers_input_text" required/>
                    </td>
                </tr>
				<?php
				...
				if ( $groups ): ?>
                    <tr>
                        <td style="padding-top: 10px;">
                            <label class="wp_sms_subscribers_label"
                                   for="wpsms_group_name"><?php _e( 'Group', 'wp-sms' ); ?>:</label>
				...
				<?php else: ?>
                    <tr>
                        <td><span class="wp_sms_subscribers_label"
                                  for="wpsms_group_name"><?php _e( 'Group', 'wp-sms' ); ?>:</span></td>
                ...
                <tr>
                    <td style="padding-top: 10px;">
                        <input type="checkbox" name="ignore_duplicate"
                               value="ignore"/> <?php _e( 'Ignore duplicate subscribers if exist to other group.', 'wp-sms' ); ?>
                    </td>
                </tr>

                <tr>
                    <td colspan="2" style="padding-top: 20px;">
                        <input type="submit" class="button-primary" name="wps_import"
                               value="<?php _e( 'Upload', 'wp-sms' ); ?>"/>
                    </td>
                </tr>
            </table>
        </form>
    ...
    <div id="export-subscriber" style="display:none;">
        <form action="<?php echo plugins_url( 'wp-sms/export.php' ); ?>" method="post">
            <table>
                <tr>
                    <td style="padding-top: 10px;">
                        <label for="export-file-type"
                               class="wp_sms_subscribers_label"><?php _e( 'Export To', 'wp-sms' ); ?></label>
