...
<table class="form-table">
    <tr>
        ...
        <td>
            <input type="text" class="regular-text<?php echo $wp_sms_input_mobile ?>" name="mobile" value="<?php echo isset($_POST['mobile']) ? htmlspecialchars($_POST['mobile'], ENT_QUOTES) : ''; ?>" id="mobile"/>
