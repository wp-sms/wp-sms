<div class="wpsms-subscribe js-wpSmsSubscribeFormContainer">
    ...
    <div class="wpsms-subscribe__form js-wpSmsSubscribeForm">
        <div class="wpsms-form-step-one js-wpSmsSubscribeStepOne">
            ...
            <?php } ?>
            <button class="wpsms-button js-wpSmsSubscribeFormButton wpsms-form-submit js-wpSmsSubmitButton"><?php _e('Subscribe', 'wp-sms'); ?></button>
        </div>
        ...
        <div class="wpsms-form-step-two js-wpSmsSubscribeStepTwo">
            ...
            <div class="wpsms-form-step-two js-wpSmsSubscribeStepTwo" style="display: none;">
                ...
                <button class="wpsms-button js-wpSmsSubscribeFormButton wpsms-activation-submit js-wpSmsActivationButton"><?php _e('Activation', 'wp-sms'); ?></button>
            </div>
            <input type="hidden" class="newsletter-form-verify" value="<?php echo wp_sms_get_option('newsletter_form_verify'); ?>">
        </div>
    </div>
