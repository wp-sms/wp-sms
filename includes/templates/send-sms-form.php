    ...
    <?php if (!$visibility): ?>
        <div class="wpsms-sendSmsForm__deactiveBlock">
            <div class="wpsms-sendSmsForm__deactiveBlock__content">
                ...
                <a target="_blank" href="<?php echo esc_url(WP_SMS_SITE . '/buy?utm_source=wp-sms&utm_medium=link&utm_campaign=send_sms'); ?>"><?php esc_html_e('Upgrade to WP SMS Pro', 'wp-sms'); ?></a>
            </div>
        </div>
    <?php else: ?>
