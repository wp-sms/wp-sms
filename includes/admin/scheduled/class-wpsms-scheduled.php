...
class Scheduled_List_Table extends \WP_List_Table {
	...
	function prepare_items() {
		...
		usort( $data, '\WP_SMS\Admin\Scheduled_List_Table::usort_reorder' );
...
class Scheduled {
	...
	public function render_page() {
		include_once WP_SMS_DIR . 'includes/admin/scheduled/class-wpsms-scheduled.php';
		...
		include_once WP_SMS_DIR . "includes/admin/scheduled/scheduled.php";
	}
}