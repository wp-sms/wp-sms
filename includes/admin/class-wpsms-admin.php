...
class Admin
{
    ...
    public function get_translations()
    {
        return [
            ...
            'privacy_compliant'            => __('Your WP Statistics settings are privacy-compliant.', 'wp-sms'),
            'non_privacy_compliant'        => __('Your WP Statistics settings are not privacy-compliant. Please update your settings.', 'wp-sms'),
