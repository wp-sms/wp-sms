<div class="wrap wpsms-wrap">
    <div class="wpsms-wrap__main wpsms-inbox-page">
        ...
        <div class="promotion-modal">
            <h3><?php _e('View Inbox / Incoming Messages', 'wp-sms'); ?></h3>
			<?= __('This feature is available through the WP-SMS Two-Way add-on which allows you to receive messages and do actions with them such as unsubscribe, cancel order, etc...'); ?>
