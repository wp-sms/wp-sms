...
class Version
{
    ...
    public function pro_meta_links($links, $file)
    {
        if ($file == 'wp-sms/wp-sms.php') {
            ...
            $links[] = '<b>' . sprintf(__('<a href="%s" target="_blank" class="wpsms-plugin-meta-link wp-sms-pro" title="Get professional package!">Get professional package!</a>', 'wp-sms'), WP_SMS_SITE . '/buy?utm_source=wp-sms&utm_medium=link&utm_campaign=header') . '</b>';
        }
