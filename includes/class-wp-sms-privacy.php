...
class WP_SMS_Privacy {
	...
	public function load_page_privacy_metabox() {
		...
		add_meta_box( 'privacy-meta-1', esc_html( get_admin_page_title() ), array( $this, 'privacy_meta_html_gdpr' ), $this->pagehook, 'side', 'core', array( '__block_editor_compatible_meta_box' => false ) );
		add_meta_box( 'privacy-meta-2', __( 'Export User’s Data related to WP-SMS', 'wp-sms' ), array( $this, 'privacy_meta_html_export' ), $this->pagehook, 'normal', 'core', array( '__block_editor_compatible_meta_box' => false ) );
		add_meta_box( 'privacy-meta-3', __( 'Erase User’s Data related to WP-SMS', 'wp-sms' ), array( $this, 'privacy_meta_html_delete' ), $this->pagehook, 'normal', 'core', array( '__block_editor_compatible_meta_box' => false ) );
	}
