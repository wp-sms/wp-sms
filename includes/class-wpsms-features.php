...
class Features
{
    ...
    public function load_international_input()
    {
        ...
        wp_enqueue_style('wpsms-intel-tel-input', WP_SMS_URL . 'public/css/intlTelInput.min.css', true, '24.8.2');
        wp_enqueue_script('wpsms-intel-tel-input', WP_SMS_URL . 'public/js/intel/intlTelInput.min.js', array('jquery'), '24.8.2', true);
        wp_enqueue_script('wpsms-intel-script', WP_SMS_URL . 'public/js/intel/intel-script.js', true, WP_SMS_VERSION, true);
        ...
        $tel_intel_vars['util_js'] = WP_SMS_URL . 'public/js/intel/utils.js';
