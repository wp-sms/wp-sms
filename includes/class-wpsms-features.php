...
class Features
{
    ...
    public function load_international_input()
    {
        ...
        wp_enqueue_style('wpsms-intel-tel-input', WP_SMS_URL . 'public/legacy/css/intlTelInput.min.css', true, '25.12.5');
        wp_enqueue_script('wpsms-intel-tel-input', WP_SMS_URL . 'public/legacy/js/intel/intlTelInput.min.js', array('jquery'), '25.12.5', true);
        wp_enqueue_script('wpsms-intel-script', WP_SMS_URL . 'public/legacy/js/intel/intel-script.js', true, WP_SMS_VERSION, true);
        ...
        $tel_intel_vars['util_js'] = WP_SMS_URL . 'public/legacy/js/intel/utils.js';
