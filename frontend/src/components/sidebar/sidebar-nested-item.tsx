...
export const SidebarNestedItem = ({ title, icon, items, showTitle = true }: SidebarNestedItemProps) => {
  ...
  return (
    <div>
      <SidebarItem
        ...
        endContent={<ChevronRightIcon size={13} className={clsx('transition-transform', isOpen ? 'rotate-90' : '')} />}
      />
