      ...
      <div {...useBlockProps()}>
        <div className="wp-sms-block wp-sms-block--sendSms">
          ...
          <div className="wp-sms-block__main">
            <TextControl label={__('Title', 'wp-sms')} value={title} onChange={onChangeTitle} />
            <TextareaControl label={__('Description', 'wp-sms')} value={description} onChange={onChangeDescription} />
