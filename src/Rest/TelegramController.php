...
class TelegramController extends Controller
{
    ...
    public function handleSetup(WP_REST_Request $request): WP_REST_Response
    {
        return $this->handle(function () use ($request) {
            ...
            if (empty($botToken)) {
                throw ValidationException::field('bot_token', __('Bot token is required.', 'wp-sms'));
            }
            ...
            if (!$me) {
                throw ValidationException::field('bot_token', __('Could not validate the bot token. Please check and try again.', 'wp-sms'));
            }
