...
class RemoveTagAction extends AbstractAction
{
    ...
    {
        return 'emailoctopus_remove_tag';
    }

    public function getName(): string
    {
        return __('Remove Tag in EmailOctopus', 'wp-sms');
    }

    public function getDescription(): string
    {
        return __('Remove a tag from a contact in EmailOctopus.', 'wp-sms');
    }
    ...
    public function getConfigSchema(): array
    {
        return [
            ...
            'tag_name' => [
                ...
                'description' => __('The tag to remove from the contact.', 'wp-sms'),
                'required'    => true,
                'template'    => true,
            ],
        ];
    ...
    public function execute(array $payload, array $config): ActionResult
    {
        ...
        try {
            $this->client->updateContact($listId, $email, [], [$tagName => false]);
