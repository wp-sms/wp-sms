...
class RemoveTagAction extends AbstractAction
{
    ...
    {
        return __('Remove Tag from Contact', 'wp-sms');
    }

    public function getDescription(): string
    {
        return __('Remove a tag from a contact', 'wp-sms');
    }
    ...
    public function getConfigSchema(): array
    {
        return [
            'contact_id' => [
                ...
                'description' => __('The contact to untag. Use {{contact_id}} from trigger data, or leave empty to resolve from user_id.', 'wp-sms'),
                'template'    => true,
                'example'     => '{{contact_id}}',
            ],
            'tag_id' => [
                'type'        => 'string',
                'label'       => __('Tag', 'wp-sms'),
                'description' => __('The tag to remove', 'wp-sms'),
                'required'    => true,
                'dynamic'     => true,
            ],
        ];
