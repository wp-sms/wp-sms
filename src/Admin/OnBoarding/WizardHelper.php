...
class WizardHelper
{
    ...
    {
        return admin_url("admin.php?page=wsms&path={$wizardSlug}&step={$stepSlug}");
    }

    public static function generateNextStepUrl($currentSlug, $wizardSlug)
    {
        return admin_url("admin.php?page=wsms&path={$wizardSlug}&step={$currentSlug}&action=next");
    }

    public static function generatePreviousStepUrl($currentSlug, $wizardSlug)
    {
        return admin_url("admin.php?page=wsms&path={$wizardSlug}&step={$currentSlug}&action=previous");
    }
