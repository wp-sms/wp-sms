...
abstract class AbstractCore
{
    ...
    {
        $options = get_option(OptionUtil::$optName);
        if (empty($options) || !is_array($options)) {
            update_option(OptionUtil::$optName, OptionUtil::defaultOptions());
        }
    }
    ...
    {
        $this->currentVersion = get_option('wp_sms_plugin_version', WP_SMS_VERSION);
    ...
    {
        update_option('wp_sms_plugin_version', $this->latestVersion);
    }
