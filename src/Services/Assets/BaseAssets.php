...
abstract class BaseAssets
{
     ...
     * @var string
     */
    private $assetVersion = WP_SMS_VERSION;
    ...
    protected function getUrl($fileName, $relativePath = false)
    {
        ...
        $filePath = wp_normalize_path(trailingslashit(WP_SMS_DIR) . $relative);
