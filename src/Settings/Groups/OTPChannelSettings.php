    ...
    public function getSections(): array
    {
        return [
            ...
            new Section([
                ...
                'fields'   => [
                    new Field([
                        'key'   => 'email_tpl_otp_heading',
                        'label' => __('OTP Code Email', 'wp-sms'),
                        'type'  => 'html',
                        'html'  => '<strong>' . esc_html__('Placeholders:', 'wp-sms') . '</strong> {{otp_code}} {{expires_in_minutes}} {{user_display_name}} {{site_name}}',
                    ]),
                    new Field([
                    ...
                    new Field([
                        ...
                        'label'             => __('Body (HTML or Text)', 'wp-sms'),
                        'type'              => 'textarea',
                        'rows'              => 10,
                    ...
                    new Field([
                        'key'   => 'email_tpl_otp_preview',
                        'label' => __('Preview', 'wp-sms'),
                        'type'  => 'html',
                    ]),

                    new Field([
                        'key'   => 'email_tpl_magic_heading',
                        'label' => __('Magic Link Email', 'wp-sms'),
                        'type'  => 'html',
                        'html'  => '<strong>' . esc_html__('Placeholders:', 'wp-sms') . '</strong> {{magic_link}} {{user_display_name}} {{expires_in_minutes}} {{site_name}}',
                    ]),
                    new Field([
                    ...
                    new Field([
                        'key'   => 'email_tpl_magic_preview',
                        'label' => __('Preview', 'wp-sms'),
                        'type'  => 'html',
                    ]),

                    new Field([
                        'key'   => 'email_tpl_reset_heading',
                        'label' => __('Password Reset Email', 'wp-sms'),
                        'type'  => 'html',
                        'html'  => '<strong>' . esc_html__('Placeholders:', 'wp-sms') . '</strong> {{reset_link}} {{user_display_name}} {{expires_in_minutes}} {{site_name}}',
                    ]),
                    new Field([
