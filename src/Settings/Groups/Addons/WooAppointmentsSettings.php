            ...
            $sections[] = new Section([
                ...
                'fields' => [
                    new Field([
                        ...
                        'type' => 'notice',
                        'description' => __('WooCommerce Appointments is not installed or active. Install and activate WooCommerce Appointments to configure SMS notifications.', 'wp-sms-booking-integrations')
                    ])
                ]
            ]);
        }
