...
class FeatureSettings extends AbstractSettingGroup
{
    ...
    public function getSections(): array
    {
        ...
        return [
            ...
            new Section([
                'id' => 'url_shortening',
                'title' => $isPro ? __('URL Shortening via Bitly', 'wp-sms') : __('URL Shortening via Bitly (Pro)', 'wp-sms'),
                'subtitle' => __('Configure URL shortening for SMS messages', 'wp-sms'),
                'tag' => !$isPro ? 'pro' : null,
                'fields' => [
                    new Field([
            ...
            new Section([
                ...
                'title' => ($isPro || $isWooPro) ? __('Google reCAPTCHA Integration', 'wp-sms') : __('Google reCAPTCHA Integration (Pro / WooCommerce Pro)', 'wp-sms'),
